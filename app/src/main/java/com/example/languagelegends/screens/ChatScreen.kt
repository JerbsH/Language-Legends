...
import com.example.languagelegends.aicomponents.AiAuthCredentials


@Composable
fun ChatScreen(aiChatViewModel: AiChatViewModel) {
    var prompt by remember { mutableStateOf("") }

    var aiAuthCredentials = AiAuthCredentials()
    ...
    Column {
        ...
        Column {
            ...
            Row {
                ...
                TextField(value = prompt, onValueChange = {prompt = it}, label = { Text("Enter your message") })
            }
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
                Button(onClick = { Log.d("auth", aiAuthCredentials.keyFile) }) {
                    Text("Send")
                }
            }
        }
